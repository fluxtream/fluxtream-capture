                            ...
                            accessToken:(NSString *)accessToken
{
    ...
    if (accessToken) {
        NSString *newURL = uploadURL.description;
        if ([newURL rangeOfString:@"?"].length) { // If url contains "?"
            newURL = [newURL stringByAppendingString:@"&"];
        } else {
            newURL = [newURL stringByAppendingString:@"?"];
        }
        newURL = [newURL stringByAppendingString:[NSString stringWithFormat:@"access_token=%@", accessToken]];
        uploadURL = newURL;
    }
