var controllers = angular.module('fcControllers', []);

// Main menu controller
controllers.controller('MainMenuController', function($scope) {});

// Polar H7 controller
controllers.controller('PolarH7Controller', function($scope) {});

// Self-reporting controller
controllers.controller('SreportsController', function($scope) {});

// Config controller
controllers.controller('ConfigController', function($scope) {});
